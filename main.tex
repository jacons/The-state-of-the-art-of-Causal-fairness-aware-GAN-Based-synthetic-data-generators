...
\newcommand{\done}{\includegraphics[width=0.02\linewidth,valign=c]{img/done.png}}
\newcommand{\rejected}{\includegraphics[width=0.02\linewidth,valign=c]{img/rejected.png}}
...
In other words, FairGAN generates the unprotected attributes $\bm{x}'$ and decision $y'$ given the protected attribute $a$, and achieves $\bm{X}' \indep A$ and $Y' \indep A$. Therefore, the generated data can meet the requirements in terms of Demographic parity (Definition~\ref{def:dp}) and FTU (Definition~\ref{def:ftu}).
...
Focusing on the objective function, the discriminator $D^2$ tries to distinguish the data distribution derived from the different protected value conditions. 
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        \textbf{Only binary $A$}            & \done            & \done          & \rejected      & \done          \\ \hline
        \textbf{Causal Notion of f.}        & \rejected        & \done          & \done          & \done          \\ \hline
        \textbf{Require $\mathcal{G}$}      & \rejected        & \done          & \done          & \rejected      \\ \hline
        \textbf{Interventional f.}          & \rejected        & \done          & \rejected      & \rejected      \\ \hline
        \textbf{Fairness in $\mathcal{L}$}  & \done            & \done          & \rejected      & \done          \\ \hline
        \textbf{Counterfactual f.}          & \rejected        & \rejected      & \rejected      & \done          \\ \hline
    \end{tabular}
